...
import 'package:jukkru/Screens/Pages/GallorySolutions/PictureHgRear.dart';
              ...
              FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot<CatTimeModel> snapshot) {
                    if (snapshot.hasData) {
                      ...
                      return Center(child: Container(child: const Text("กรุณาเปลี่ยนรูปด้านหลังโค",style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold)),));
                    }
                  })
            ],
          );
