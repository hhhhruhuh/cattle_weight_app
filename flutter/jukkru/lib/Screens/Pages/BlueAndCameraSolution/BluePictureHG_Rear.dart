...
import 'package:jukkru/Screens/Pages/BlueAndCameraSolution/BluePictureSaveNext.dart';
          ...
          children: [
            ...
            showState
                ...
                : AlertDialog(
                    ...
                    title: const Text("กรุณาระบุความกว้างกระดูกก้นกบของโค",
                        style: TextStyle(
...
class LineAndPositionPictureHG_Rear extends StatefulWidget {
  ...
  const LineAndPositionPictureHG_Rear(
      {Key? key, required this.imgPath,required this.fileName,required this.onSelected}) : super(key: key);

  @override
  LineAndPositionPictureHG_RearState createState() =>
      LineAndPositionPictureHG_RearState();
}
