  ...
  Future<Database> initDatabase() async {
    ...
    var db = await openDatabase(
      ...
      onCreate: (database, version) {
        ...
        database.execute(
            'CREATE TABLE catTime(id INTEGER PRIMARY KEY AUTOINCREMENT, CPid INTEGER,bodyLenght DOUBLE,heartGirth DOUBLE,hearLenghtSide DOUBLE,hearLenghtRear DOUBLE,hearLenghtTop DOUBLE,PixelReference DOUBLE,DistanceReference DOUBLE,date DATETIME)' 'FOREIGN KEY(CPid) REFERENCES catPro(id))');
      },
    );
    return db;
  }
